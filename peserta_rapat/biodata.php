  ...
  <style>
   ...
   ============================ */
    ...
    .sidebar {
      ...
      /* <- ini membuat logout selalu di bawah */
      padding: 40px 25px;
      height: 100vh;
      position: fixed;
      left: 0;
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-9">
          ...
          <table class="table table-borderless">
            <tr>
              <th>Nama</th>
              <td>: <?= htmlspecialchars($peserta['name']) ?></td>
            </tr>
            <tr>
              <th>Email</th>
              <td>: <?= htmlspecialchars($peserta['p_email']) ?></td>
            </tr>
            <tr>
              <th>No. HP</th>
              <td>: <?= htmlspecialchars($peserta['phone'] ?? '-') ?></td>
            </tr>
            <tr>
              <th>Instansi</th>
              <td>: <?= htmlspecialchars($peserta['department'] ?? '-') ?></td>
            </tr>
          </table>
