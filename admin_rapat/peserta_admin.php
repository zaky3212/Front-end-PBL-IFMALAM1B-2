  ...
  <div class="peserta-container">
    ...
    <div class="tools-section">
      ...
      <div class="action-tools">
        <button class="btn-tool" id="btnExport"><i class="fas fa-download"></i> Export</button>
        <button class="btn-tool" id="btnPrint"><i class="fas fa-print"></i> Print</button>
      </div>
    </div>
...
window.addEventListener('click', e => { if (e.target === modalPeserta) tutupModal(); });
