...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Nov 2025 pada 16.19
...
CREATE TABLE `meetings_participant` (
  ...
  `attendance_status` enum('attending','not_attending','pending') DEFAULT 'pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `meetings_participant`
  ...
  ADD CONSTRAINT `meetings_participant_ibfk_2` FOREIGN KEY (`participant_id`) REFERENCES `participant` (`id`) ON DELETE CASCADE;
COMMIT;
